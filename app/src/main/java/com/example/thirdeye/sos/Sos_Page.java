package com.example.thirdeye.sos;
...
import com.example.thirdeye.sos.Contacts.Contact;
import com.example.thirdeye.sos.Contacts.ContactAdapter;
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(db.count()!=5) {
                    ...
                    Toast.makeText(Sos_Page.this, "Can't Add more than 5 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        try {
                            ...
                            db.addcontact(new Contact(0,name,phone));
                            list=db.getAllContacts();
